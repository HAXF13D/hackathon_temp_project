          ...
          <thead>
            <tr>
              <th 
                ...
                @click="sortUserName()">Пользователь<i class="bi bi-sort-up ps-1"></i>
              </th>
              <th 
                v-else-if="userNameSort === 'DECRESE' " 
                scope="col" 
                class="ps-3 disabled header-text pb-1 rating-text sort-choosed" 
                @click="sortUserName()">Пользователь<i class="bi bi-sort-down ps-1"></i>
              </th>
              <th 
                v-else scope="col" 
                class="ps-3 disabled header-text pb-1 rating-text sort-choosedt"
                @click="sortUserName()">Пользователь
              </th>
              ...
              <th 
                ...
                @click="sortBalance()">Баланс<i class="bi bi-sort-up ps-1"></i>
              </th>
              <th 
                v-else-if="userBalanceSort === 'DECRESE' " 
                scope="col" 
                class="pe-3 disabled header-text pb-1 rating-text sort-choosed text-end" 
                @click="sortBalance()">Баланс<i class="bi bi-sort-down ps-1"></i>
              </th>
              <th 
                v-else scope="col" 
                class="pe-3 disabled header-text pb-1 rating-text sort-choosedt text-end" 
                @click="sortBalance()">Баланс
              </th>
            </tr>
          </thead>
          <UserCard 
